...
# Create a secret
awslocal secretsmanager create-secret --name test-secret --secret-string "{\"username\": \"root\", \"password\": \"password\", \"engine\": \"mongo\", \"host\": \"localhost\", \"port\": 27017, \"ssl\": false, \"dbname\": \"admin\"}"
