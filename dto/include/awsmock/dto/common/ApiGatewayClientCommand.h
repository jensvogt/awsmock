...
namespace Awsmock::Dto::Common {
    ...
    static std::map<ApiGatewayCommandType, std::string> ApiGatewayCommandTypeNames{
            ...
            {ApiGatewayCommandType::ENABLE_API_KEY, "enable-api-key"},
            {ApiGatewayCommandType::DISABLE_API_KEY, "disable-api-key"},
            ...
            {ApiGatewayCommandType::CREATE_DEPLOYMENT, "create-deployment"},
            {ApiGatewayCommandType::UPDATE_DEPLOYMENT, "update-deployment"},
            {ApiGatewayCommandType::DELETE_DEPLOYMENT, "delete-deployment"},
            {ApiGatewayCommandType::CREATE_AUTHORIZER, "create-authorizer"},
            {ApiGatewayCommandType::DELETE_AUTHORIZER, "delete-authorizer"},
