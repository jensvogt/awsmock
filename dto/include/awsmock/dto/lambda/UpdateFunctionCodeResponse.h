...
namespace AwsMock::Dto::Lambda {
     ...
     * @endcode
     */
    struct UpdateFunctionCodeResponse final : Common::BaseCounter<UpdateFunctionCodeResponse> {
      ...
      private:
        ...
        friend UpdateFunctionCodeResponse tag_invoke(boost::json::value_to_tag<UpdateFunctionCodeResponse>, boost::json::value const &v) {
            UpdateFunctionCodeResponse r;
        ...
        friend void tag_invoke(boost::json::value_from_tag, boost::json::value &jv, UpdateFunctionCodeResponse const &obj) {
            jv = {
