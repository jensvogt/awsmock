...
namespace AwsMock::Dto::Common {
    ...
    std::string ContainerClientCommand::ToJson() const {
        ...
        try {
            ...
            Core::Bson::BsonUtils::SetStringValue(document, "command", ContainerCommandTypeToString(command));
    ...
    std::string ContainerClientCommand::ToString() const {
        std::stringstream ss;
        ss << *this;
        return ss.str();
    }

    std::ostream &operator<<(std::ostream &os, const ContainerClientCommand &r) {
        os << "ContainerClientCommand=" << r.ToJson();
        return os;
    }
