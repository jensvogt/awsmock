...
namespace AwsMock::Core {
    ...
    BOOST_AUTO_TEST_CASE(VerifySignatureTest, *boost::unit_test::disabled()) {
        ...
        request.set(boost::beast::http::field::host, "examplebucket.s3.amazonaws.com");
        request.set(boost::beast::http::field::authorization, "AWS4-HMAC-SHA256 Credential=AKIAIOSFODNN7EXAMPLE/20130524/us-east-1/s3/aws4_request,SignedHeaders=host;range;x-amz-content-sha256;x-amz-date,Signature=1a276044bd879aeb04a95effe35bcddeee46de6d2689e6ff12ec4d23d8e06274");
        request.set(boost::beast::http::field::range, "bytes=0-9");
