...
namespace AwsMock::Monitoring {
    ...
    public:
        ...
        ~MonitoringTimer() {
            ...
            if (_labelName.empty()) {
                _monitoringCollector.SetGauge(_timerName, static_cast<double>(TIME_DIFF));
                log_trace << "Timer deleted, name: " << _timerName;
            } else {
                _monitoringCollector.SetGauge(_timerName, _labelName, _labelValue, static_cast<double>(TIME_DIFF));
