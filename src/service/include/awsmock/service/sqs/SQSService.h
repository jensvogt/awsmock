...
namespace AwsMock::Service {
    ...
    class SQSService {
      ...
      public:
         ...
         * @brief Constructor
         */
        explicit SQSService(boost::beast::tcp_stream &stream) : _sqsDatabase(Database::SQSDatabase::instance()), _lambdaDatabase(Database::LambdaDatabase::instance()),
                                                                _lambdaService(stream) {};
