...
namespace AwsMock::Service {
    ...
    class S3Service {
      ...
      public:
         ...
         * @brief Constructor
         */
        explicit S3Service(boost::beast::tcp_stream &stream) : _database(Database::S3Database::instance()), _lambdaService(stream), _sqsService(stream), _snsService(stream) {};
         ...
         * @return PutObjectResponse
         */
        [[nodiscard]] Dto::S3::CopyObjectResponse CopyObject(const Dto::S3::CopyObjectRequest &request);
         ...
         * @return PutObjectResponse
         */
        [[nodiscard]] Dto::S3::MoveObjectResponse MoveObject(const Dto::S3::MoveObjectRequest &request);
