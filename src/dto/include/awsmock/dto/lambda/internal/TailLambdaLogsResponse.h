...
#ifndef AWSMOCK_DTO_LAMBDA_TAIL_LAMBDA_LOGS_RESPONSE_H
#define AWSMOCK_DTO_LAMBDA_TAIL_LAMBDA_LOGS_RESPONSE_H
...
#endif// AWSMOCK_DTO_LAMBDA_TAIL_LAMBDA_LOGS_RESPONSE_H
