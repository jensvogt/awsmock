...
#ifndef AWSMOCK_CORE_ONE_TIME_TASK_H
#define AWSMOCK_CORE_ONE_TIME_TASK_H
...
namespace AwsMock::Core {
     ...
     *
     * @par
     * This class starts an asynchronous task once
     *
    ...
    class OneTimeTask : boost::noncopyable {
      ...
      public:
         ...
         * @param task task
         */
        OneTimeTask(boost::asio::io_context &ioService, std::string const &name, long delay, handler_fn task);
...
#endif// AWSMOCK_CORE_ONE_TIME_TASK_H
