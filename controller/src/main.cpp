...
static void ShowHelp(const boost::program_options::options_description &desc) {
    ...
    std::cout << std::left << std::setw(leftIndent) << "  set-loglevel <level> [<channel>]" << ": sets the manager log to level, if no channel is given, set all" << std::endl
            ...
            << std::left << std::setw(leftIndent) << "  export [<modules>] [export-options] [--file <file>]" << ": dumps the current infrastructure to stdout or a file. Modules is a space separated list of module names." << std::endl
            << std::left << std::setw(leftIndent) << "  import [--file <file>]" << ": imports the infrastructure from stdin or a file." << std::endl
            ...
            << std::left << std::setw(leftIndent) << "  --file <file>" << ": import from/export to a file" << std::endl
            << "\nLog levels:" << std::endl
