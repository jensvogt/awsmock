...
namespace AwsMock::Database::Entity::S3 {
    ...
    std::vector<QueueNotification> Bucket::GetQueueNotifications(const std::string &eventName) {
    ...
    std::vector<TopicNotification> Bucket::GetTopicNotifications(const std::string &eventName) {
    ...
    std::vector<LambdaNotification> Bucket::GetLambdaNotifications(const std::string &eventName) {
