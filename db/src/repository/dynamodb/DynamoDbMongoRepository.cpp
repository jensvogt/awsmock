...
namespace Awsmock::Database {
    ...
    Entity::DynamoDb::Table DynamoDbMongoRepository::createTable(Entity::DynamoDb::Table &table) const {
    ...
    Entity::DynamoDb::Table DynamoDbMongoRepository::getTableById(const bsoncxx::oid &oid) const {
    ...
    Entity::DynamoDb::Table DynamoDbMongoRepository::getTableById(const std::string &oid) const {
        return getTableById(bsoncxx::oid(oid));
    }

    Entity::DynamoDb::Table DynamoDbMongoRepository::getTableByRegionName(const std::string &region, const std::string &name) const {
    ...
    std::vector<Entity::DynamoDb::Table> DynamoDbMongoRepository::listTables(const std::string &region, const std::string &prefix, const int pageSize, const int pageIndex, const std::vector<SortColumn> &sortColumns) const {
    ...
    long DynamoDbMongoRepository::countTables(const std::string &region, const std::string &prefix) const {
    ...
    Entity::DynamoDb::Table DynamoDbMongoRepository::createOrUpdateTable(Entity::DynamoDb::Table &table) const {
    ...
    Entity::DynamoDb::Table DynamoDbMongoRepository::updateTable(Entity::DynamoDb::Table &table) const {
        ...
        try {
            ...
            if (const auto mResult = _tableCollection.find_one_and_update(query.extract(), table.ToDocument(), opts)) {
    ...
    void DynamoDbMongoRepository::updateTableCounter(const std::string &tableArn, const long items, const long size) const {
        Monitoring::MonitoringTimer measure(DYNAMODB_DATABASE_TIMER, DYNAMODB_DATABASE_COUNTER, "action", "update_table");
    ...
    void DynamoDbMongoRepository::deleteTable(const std::string &region, const std::string &tableName) const {
    ...
    long DynamoDbMongoRepository::deleteAllTables() const {
    ...
    bool DynamoDbMongoRepository::itemExists(const Entity::DynamoDb::Item &item) const {
    ...
    bool DynamoDbMongoRepository::itemExists(const std::string &region, const std::string &tableName, std::string &partitionKey, const std::string &sortKey) const {
        Monitoring::MonitoringTimer measure(DYNAMODB_DATABASE_TIMER, DYNAMODB_DATABASE_COUNTER, "action", "item_exists");
    ...
    Entity::DynamoDb::ItemList DynamoDbMongoRepository::listItems(const std::string &region, const std::string &tableName, const long pageSize, const long pageIndex, const std::vector<SortColumn> &sortColumns) const {
    ...
    Entity::DynamoDb::Item DynamoDbMongoRepository::getItemById(const bsoncxx::oid &oid) const {
    ...
    Entity::DynamoDb::Item DynamoDbMongoRepository::getItemById(const std::string &oid) const {
        return getItemById(bsoncxx::oid(oid));
    }

    Entity::DynamoDb::Item DynamoDbMongoRepository::getItemByKeys(const std::string &region, const std::string &tableName, const Entity::DynamoDb::KeyValue &partitionKey, const Entity::DynamoDb::KeyValue &sortKey) const {
    ...
    Entity::DynamoDb::Item DynamoDbMongoRepository::createItem(Entity::DynamoDb::Item &item) const {
    ...
    Entity::DynamoDb::Item DynamoDbMongoRepository::updateItem(Entity::DynamoDb::Item &item) const {
    ...
    Entity::DynamoDb::Item DynamoDbMongoRepository::createOrUpdateItem(Entity::DynamoDb::Item &item) const {
    ...
    long DynamoDbMongoRepository::countItems(const std::string &region, const std::string &tableName, const std::string &prefix) const {
    ...
    void DynamoDbMongoRepository::deleteItem(const std::string &region, const std::string &tableName, const std::string &partitionKey, const std::string &sortKey) const {
    ...
    long DynamoDbMongoRepository::deleteItems(const std::string &region, const std::string &tableName) const {
    ...
    long DynamoDbMongoRepository::deleteAllItems() const {
    ...
    std::vector<Entity::DynamoDb::Item> DynamoDbMongoRepository::getItems(const std::string &region, const std::string &tableName) const {
    ...
    std::vector<Entity::DynamoDb::Item> DynamoDbMongoRepository::executeQuery(const DynamoToMongoTranslator::DynamoRequest &req, const bool scanIndexForward, const int limit) const {
    ...
    std::vector<Entity::DynamoDb::Item> DynamoDbMongoRepository::executeQuery(const value &filter, const bool scanIndexForward, const int limit) const {
        Monitoring::MonitoringTimer measure(DYNAMODB_DATABASE_TIMER, DYNAMODB_DATABASE_COUNTER, "action", "execute_query");
    ...
    void DynamoDbMongoRepository::adjustItemCounters() const {
