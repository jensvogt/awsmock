...
namespace AwsMock::Database {
    ...
    BOOST_FIXTURE_TEST_CASE(TopicCreateTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(TopicGetByIdTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(TopicUpdateTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(TopicCountTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(TopicListTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(TopicGetBySubscriptionArnTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(TopicDeleteTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(MessageCreateTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(MessageCountTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(MessageDeleteTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(MessagesDeleteTest, SNSDatabaseTest) {
    ...
    BOOST_FIXTURE_TEST_CASE(MessageDeleteAllTest, SNSDatabaseTest) {
