...
namespace Awsmock::Database {
    ...
    struct SecretsmanagerMemoryDbFixture {
        ...
        ~SecretsmanagerMemoryDbFixture() {
            const long secretsCount = RepositoryFactory::instance().secretsmanagerRepository()->DeleteAllSecrets();
    ...
    BOOST_AUTO_TEST_CASE(SecretCreateTest) {
        ...
        // arrange
        const std::shared_ptr<ISecretsManagerRepository> secretsmanagerDatabase = RepositoryFactory::instance().secretsmanagerRepository();
