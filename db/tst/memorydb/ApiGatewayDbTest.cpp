...
namespace Awsmock::Database {
    ...
    struct ApiGatewayMemoryDbFixture {
        ApiGatewayMemoryDbFixture() {
    ...
    BOOST_FIXTURE_TEST_SUITE(ApiGatewayMemoryDbTests, ApiGatewayMemoryDbFixture)
    ...
    BOOST_AUTO_TEST_CASE(ApiKeyExistsById) {
        ...
        BOOST_CHECK_EQUAL(key.id.empty(), false);
    }
    ...
    BOOST_AUTO_TEST_CASE(ApiKeyGetAll) {
        ...
        BOOST_CHECK_EQUAL(key1.id.empty(), false);
        BOOST_CHECK_EQUAL(key2.id.empty(), false);
    }
    ...
    BOOST_AUTO_TEST_CASE(RestApiExistsByRegionName) {
        ...
        // assert
        BOOST_CHECK_EQUAL(result, true);
        BOOST_CHECK_EQUAL(restApi.id.empty(), false);
    }
    ...
    BOOST_AUTO_TEST_CASE(RestApiListCounters) {
        ...
        // assert
        BOOST_CHECK_EQUAL(2, result.size());
        BOOST_CHECK_EQUAL(api1.id.empty(), false);
        BOOST_CHECK_EQUAL(api2.id.empty(), false);
    }
