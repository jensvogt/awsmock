...
namespace Awsmock::Database {
    ...
    static Dto::SQS::CreateQueueResponse CreateDefaultQueue(const Service::SQSService &sqsService) {
    ...
    static Dto::SQS::SendMessageResponse SendDefaultMessage(const Service::SQSService &sqsService, const std::string &queueUrl) {
    ...
    static void CreateLambdaWithSqsEventSource(const std::string &queueArn) {
        ...
        std::ignore = RepositoryFactory::instance().lambdaRepository()->createLambda(lambda);
    }
