...
namespace Awsmock::Database {
    ...
    static Dto::SNS::CreateTopicResponse CreateDefaultTopic(const Service::SNSService &snsService) {
    ...
    static Dto::SQS::CreateQueueResponse CreateDefaultSubscriptionQueue(const Service::SQSService &sqsService) {
    ...
    static Dto::SNS::SubscribeResponse SubscribeQueueToTopic(const Service::SNSService &snsService, const std::string &topicArn, const std::string &queueArn) {
