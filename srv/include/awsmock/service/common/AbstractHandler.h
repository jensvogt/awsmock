...
namespace AwsMock::Service {
  ...
  public:
     ...
     * @return HTTP response
     */
    static http::response<http::dynamic_body> SendResponse(const http::request<http::dynamic_body> &request, const std::string &fileName, long min, long max, long size, long totalSize, const http::status &status,
